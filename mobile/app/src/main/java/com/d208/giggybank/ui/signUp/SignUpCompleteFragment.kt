package com.d208.giggybank.ui.signUp
...
import com.d208.giggybank.databinding.FragmentSignUpCompleteBinding
...
class SignUpCompleteFragment : BaseFragment<FragmentSignUpCompleteBinding>(FragmentSignUpCompleteBinding::bind, R.layout.fragment_sign_up_complete) {
    ...
    companion object {
         ...
         * @return A new instance of fragment SignUpCompleteFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SignUpCompleteFragment().apply {
