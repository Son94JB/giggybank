package com.d208.buildsrc

import com.d208.buildsrc.Versions.NAV_VERSION
...
object DaggerHilt {
    const val DAGGER_HILT = "com.google.dagger:hilt-android:2.47"
...
object Firebase{
    const val FIREBASE_DATABASE_KTX = "com.google.firebase:firebase-database-ktx:22.0.0"
    const val FIREBASE_FIRESTORE_KTX = "com.google.firebase:firebase-firestore-ktx:24.0.0"
    const val FIREBASE_BOM_KTX = "com.google.firebase:firebase-bom:32.1.0"
    const val FIREBASE_MESSAGING_KTX = "com.google.firebase:firebase-messaging:22.0.0"
    const val FIREBASE_MESSAING = "com.google.firebase:firebase-messaging-ktx"
    const val FIREBASE_ANALYTICS = "com.google.firebase:firebase-analytics-ktx"
}

object TestTool {
    const val JUNIT = "junit:junit:4.13.2"
    const val ANDROID_X_JUNIT = "androidx.test.ext:junit:1.1.5"
...
object Library{
    ...
    const val PIE_GRAPH = "com.github.PhilJay:MPAndroidChart:v3.1.0"
...
object KaKao{
    const val KAKAO_LOGIN = "com.kakao.sdk:v2-user:2.12.1"
